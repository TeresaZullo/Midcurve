...
#plot seconda calibrazione
    ...
    df_swaption_1 = pd.DataFrame({
        "Strike": market_swaption_1["strike"],
        "Strike Adj": strike_1_adj_list,
        "Alpha 1 Adj": alpha_1_adj_list
        })

    df_swaption_2 = pd.DataFrame({
        "Strike": market_swaption_2["strike"],
